 ...
 */
void InputChannel::setAddr(Address newAddress) { addr = newAddress; }
 ...
 */
void InputChannel::setRC(RouteComputation *rcomp) { RC = rcomp; }
 ...
 */
void InputChannel::setTarget(OutputChannel *t) { target = t; }
 ...
 */
OutputChannel *InputChannel::getTarget() const { return target; }
 ...
 */
void InputChannel::setWB(OutputChannel *writeback) { wb = writeback; }
